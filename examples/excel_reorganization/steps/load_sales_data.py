...
This step reads a flat CSV file with columns (Employee Name, Date, Amount, Country),
validates the schema, and stores the data in ctx.state["sales_data"] as a list of dicts.

Pattern: Follows examples/json_event_log_processor/steps/load_json_file.py:16-52
"""
