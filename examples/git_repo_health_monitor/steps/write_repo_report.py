...
class WriteRepoReport(Step):
    ...
    Raises BusinessException(halts_remaining_steps=True) for "degraded" and "unhealthy" repos
    ...
    def execute(self, ctx: ProcessContext) -> None:
        ...
        # Collect data from upstream steps using optional_state with defaults
        ...
        # so halts_remaining_steps=True has minimal downstream impact (WriteRepoReport is last step).
