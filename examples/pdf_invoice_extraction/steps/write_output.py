...
from rpacore import BusinessException, ProcessContext, Step, Status, SystemException, get_logger
...
class WriteOutput(Step):
    ...
    On duplicate: raises BusinessException (halts_remaining_steps=True) for duplicate invoice numbers.
    """
