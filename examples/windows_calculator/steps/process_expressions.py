"""RPA Core step: type each expression into Calculator and compare results."""
from __future__ import annotations

import logging

from rpacore import ProcessContext, Step, Status, SystemException

logger = logging.getLogger(__name__)


class ProcessExpressions(Step):
